...
opscen2 = OperationalScenarios(4,[SimpleTimes(5,1.5), SimpleTimes(3,2), SimpleTimes(4,[3,2,1,1]), SimpleTimes(2,3)], [0.3, 0.4, 0.3])
...
TimeStructPlotting.draw(twolev; layout = :top, showdur = true, profile = p1)
